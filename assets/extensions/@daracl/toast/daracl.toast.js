...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Daracl"] = factory();
	else
		root["Daracl"] = root["Daracl"] || {}, root["Daracl"]["toast"] = factory();
})(self, function() {
...
function toastHiddenElement() {
  if (document.getElementById("daraclToastHidden") == null) {
    ...
    (_document$querySelect = document.querySelector("body")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.insertAdjacentHTML("beforeend", "<div id=\"daraclToastHidden\" class=\"daracl-toast-hidden\"></div>");
  }
...
var Toast = /*#__PURE__*/function () {
  function Toast(options) {
     ...
     * @returns
     */
    _defineProperty(this, "show", function (viewItems) {
      ...
      var enableCloseButton = _this.options.enableCloseButton;
      var enableProgress = _this.options.enableProgress;
      var duration = _this.options.duration;
      var textColor = _this.options.textColor;
      items.forEach(function (item) {
        ...
        _this.addItem(Object.assign({}, defaultToastItem, viewItem));
      });
      return _this;
    });
    /**
    ...
    _defineProperty(this, "destroy", function () {
      toastHiddenElement().removeChild(_this.toastWrapperElement);
    });
    ...
    var toastWrapperElement = document.createElement("div");
    toastWrapperElement.className = "daracl-toast-wrapper ".concat(position.vertical, " ").concat(position.horizontal, " dt-").concat(TOAST_IDX);
  ...
  return _createClass(Toast, [{
    ...
    function addItem(item) {
      var _styleClassMap$style,
        _this2 = this;
      var enableHeader = item.title ? true : false;
      var toast = document.createElement("div");
      var style = item.style ? item.style : this.options.style;
      var styleClass = (_styleClassMap$style = styleClassMap[style]) !== null && _styleClassMap$style !== void 0 ? _styleClassMap$style : styleClassMap.success;
      toast.className = "daracl-toast ".concat(styleClass, " ").concat(enableHeader ? "header-mode" : "");
      this.viewItemCount += 1;
      var toastHtml = "\n            ".concat(enableHeader ? "<div class=\"toast-header\" style=\"color:".concat(item.textColor, ";\" >").concat(item.title, "</div>") : "", "\n            <div class=\"toast-body\">\n                <div class=\"toast-content\" style=\"color:").concat(item.textColor, ";\" >").concat(item.text, "</div>\n            </div>\n            ").concat(item.enableCloseButton ? '<span class="toast-close">×</span>' : "", "\n            ").concat(item.enableProgress ? "<div class=\"progress-bar\" style=\"animation: progressAnimation ".concat(item.duration, "s;\"></div>") : "", "\n        ");
    ...
    function hide(toast) {
      ...
      setTimeout(function () {
        return _this3.toastWrapperElement.removeChild(toast);
      }, 500);
...
//# sourceMappingURL=daracl.toast.js.map